...
<head>
  ...
  <!-- css -->
  {!!Html::style('medicio/css/bootstrap.min.css')!!}
  {!!Html::style('medicio/font-awesome/css/font-awesome.min.css')!!}
  {!!Html::style('medicio/plugins/cubeportfolio/css/cubeportfolio.min.css')!!}
  {!!Html::style('medicio/css/nivo-lightbox.css')!!}
  {!!Html::style('medicio/css/nivo-lightbox-theme/default/default.css')!!}
  {!!Html::style('medicio/css/owl.carousel.css')!!}
  {!!Html::style('medicio/css/owl.theme.css')!!}>
  {!!Html::style('medicio/css/animate.css')!!}
  {!!Html::style('medicio/css/style.css')!!}

  <!-- boxed bg -->
  {!!Html::style('medicio/bodybg/bg1.css')!!}
  <!-- template skin -->
  {!!Html::style('medicio/color/default.css')!!}
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  {!!Html::script('medicio/js/jquery.min.js')!!}
  {!!Html::script('medicio/js/bootstrap.min.js')!!}
  {!!Html::script('medicio/js/jquery.easing.min.js')!!}
  {!!Html::script('medicio/js/wow.min.js')!!}
  {!!Html::script('medicio/js/jquery.scrollTo.js')!!}
  {!!Html::script('medicio/js/jquery.appear.js')!!}
  {!!Html::script('medicio/js/stellar.js')!!}
  {!!Html::script('medicio/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js')!!}
  {!!Html::script('medicio/js/owl.carousel.min.js')!!}
  {!!Html::script('medicio/js/nivo-lightbox.min.js')!!}
  {!!Html::script('medicio/js/custom.js')!!}
